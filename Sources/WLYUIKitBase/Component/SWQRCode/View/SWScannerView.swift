...
private let flashlightBtn_width: CGFloat = 40.0  /** 手电筒按钮宽度 */
...
class SWScannerView: UIView {
    ...
    init(frame: CGRect, config: SWQRCodeCompat) {
        ...
        scanner_y = 128 + GConfig.TopSafeH
        self.config = config
...
// MARK: - 手电筒点击事件
    ...
    private lazy var flashlightBtn: UIButton = {
        ...
        tempFlashlightBtn.setBackgroundImage(UIImage(named: "Flashlight_Off"), for: .normal)
        tempFlashlightBtn.setBackgroundImage(UIImage(named: "Flashlight_On"), for: .selected)
