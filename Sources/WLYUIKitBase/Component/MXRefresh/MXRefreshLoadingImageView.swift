...
class MXRefreshLoadingImageView: UIView {
    ...
    private func initSublayers(){
        ...
        let path = UIBezierPath.init(arcCenter: CGPoint.init(x: self.bigLoadingCircle.frame.width / 2.0, y: self.bigLoadingCircle.frame.width / 2.0), radius: self.bigLoadingCircle.frame.width / 2.0, startAngle: 0, endAngle:CGFloat(.pi * 2.0), clockwise: true)
        
        self.bigLoadingCircle.path = path.cgPath
        
        self.bigLoadingCircle.lineWidth = 1.0
        
        self.bigLoadingCircle.strokeColor = UIColor.white.cgColor

        self.bigLoadingCircle.fillColor = UIColor.white.cgColor
        ...
        for i in 0..<5 {
            ...
            let minPath = UIBezierPath.init(arcCenter: CGPoint.init(x: minLoadingCircle.frame.width / 2.0, y: minLoadingCircle.frame.height / 2.0), radius: minLoadingCircle.frame.width / 2.0, startAngle: 0, endAngle: CGFloat(.pi * 2.0), clockwise: true)
            
            minLoadingCircle.path = minPath.cgPath
            
            minLoadingCircle.lineWidth = 1.0
            
            minLoadingCircle.strokeColor = UIColor.white.cgColor
            
            minLoadingCircle.fillColor = UIColor.white.cgColor
    ...
    private func initAnimations(){
        ...
        self.bigLoadingCircleAnimation.values = [
            UIBezierPath.init(arcCenter: CGPoint.init(x: self.bigLoadingCircle.frame.width / 2.0, y: self.bigLoadingCircle.frame.width / 2.0), radius: self.bigLoadingCircle.frame.width / 3.0, startAngle: 0, endAngle:CGFloat(.pi * 2.0), clockwise: true).cgPath,
            UIBezierPath.init(arcCenter: CGPoint.init(x: self.bigLoadingCircle.frame.width / 2.0, y: self.bigLoadingCircle.frame.width / 2.0), radius: self.bigLoadingCircle.frame.width / 4.0, startAngle: 0, endAngle:CGFloat(.pi * 2.0), clockwise: true).cgPath,
            UIBezierPath.init(arcCenter: CGPoint.init(x: self.bigLoadingCircle.frame.width / 2.0, y: self.bigLoadingCircle.frame.width / 2.0), radius: self.bigLoadingCircle.frame.width / 5.0, startAngle: 0, endAngle:CGFloat(.pi * 2.0), clockwise: true).cgPath,
            UIBezierPath.init(arcCenter: CGPoint.init(x: self.bigLoadingCircle.frame.width / 2.0, y: self.bigLoadingCircle.frame.width / 2.0), radius: self.bigLoadingCircle.frame.width / 6.0, startAngle: 0, endAngle:CGFloat(.pi * 2.0), clockwise: true).cgPath,
            UIBezierPath.init(arcCenter: CGPoint.init(x: self.bigLoadingCircle.frame.width / 2.0, y: self.bigLoadingCircle.frame.width / 2.0), radius: 2.5, startAngle: 0, endAngle:CGFloat(.pi * 2.0), clockwise: true).cgPath
        ]
        
        self.bigLoadingCircleAnimation.timingFunctions = [CAMediaTimingFunction.init(name: CAMediaTimingFunctionName.linear)]
        ...
        for index in 0..<self.minLoadingCircles.count {
            ...
            circleMovePath.addArc(center: CGPoint.init(x: self.frame.width / 2.0, y: self.frame.height + 6.0), radius: self.frame.width / 2.0 + 6.0, startAngle: 0.0, endAngle: CGFloat(.pi * 2.0), clockwise: false)
            //每一个间隔0.2秒
