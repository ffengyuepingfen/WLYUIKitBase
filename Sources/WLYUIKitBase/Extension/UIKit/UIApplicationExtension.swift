...
public extension UIApplication {
    ...
    static var userAgent: String {
        ...
        return "JK" + Bundle.appVersion
    }
    
    // MARK: 1.4、app定位区域
    /// app定位区域
    static var localizations: String? {
        guard let weakInfoDictionary = Bundle.infoDic, let content = weakInfoDictionary[String(kCFBundleLocalizationsKey)] else {
            return nil
        }
